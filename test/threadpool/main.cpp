...
#include "ipoll.h"
#include "dispatch_models/threadpool/dispatcher.h"
...
class Responder :public g2io::IHandlerBase
	...
	public:
		...
		virtual IHandlerBase::result Handle( int events, g2io::IPoll &poll )
			{
...
int main(int, char **argv)
	{
	g2io::Dispatcher disp( atoi( argv[1] ), atoi( argv[2] ) );
	Acceptor a;
